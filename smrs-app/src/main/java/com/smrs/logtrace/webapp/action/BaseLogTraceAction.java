 ...
 *
 */
public abstract class BaseLogTraceAction extends BaseConsoleAction {
	...
	protected List<LogTraceTypeEnum> logTraceTypeList = DictConstants.getInstance().getLogTraceTypeList();
	
	//sortIndexList;

	public List<LogTraceTypeEnum> getLogTraceTypeList() {
