...
<div class="section">
	...
	<div class="box">
		...
		<div class="content">
			<s:form action="addItem" namespace="/goods" method="post" id="createForm">
				...
				<input type="submit" value="创建" class="button orange" onclick="createModel()" />&nbsp;&nbsp;
					...
					<button type="button" class="button orange"  onclick="createSkuForm('<s:property value="goodsItem.id"/>')"><span>继续创建产品Sku</span></button>
				</div> 
			</s:form>
		</div>
	</div>
