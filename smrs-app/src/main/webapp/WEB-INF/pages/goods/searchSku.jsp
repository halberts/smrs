...
<div class="section">
	...
	<div class="box">
		...
		<div class="content">
			<s:form action="searchSku" namespace="/goods" method="get" id="searchForm">
				<table>
					<tr>
						<th>名称：</th>
						<th><s:textfield name="goodsSku.name" /></th>
						<th>
							<button type="submit" class="orange" onclick="submitForm('searchSku');"><span>查询</span></button>
	...
	<div class="box">
		...
		<div class="content">
			...
			<table class="sorting"> 
				...
				<tbody>
					<!-- 数据行 -->
					<s:iterator value="pager.records" var="goodsSku" status="status">
						<tr>
...
function delForm(id){
	...
	window.location.href = "${dynamicURL}/goods/deleteSku.action?goodsSku.id="+id;
}

//删除
function updateForm(id){
	window.location.href = "${dynamicURL}/goods/updateSku.action?goodsSku.id="+id;
}

function createForm(){
	document.getElementById('searchForm').onsubmit=function(){ return false; };
	window.location.href = "${dynamicURL}/goods/addSku.action";
}
