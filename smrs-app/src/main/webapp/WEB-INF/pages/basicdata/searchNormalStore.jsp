...
<div class="section">
	...
	<div class="box">
		...
		<div class="content">
			<s:form action="searchNormalStore" namespace="/basicdata" method="get" id="searchForm">
				<table>
					<tr>
						<th>名称：</th>
						<th><s:textfield name="store.name" /></th>
						<th>
							<button type="submit" class="orange" onclick="submitForm('searchNormalStore');"><span>查询</span></button>
...
function delStore(id){
	...
	window.location.href = "${dynamicURL}/basicdata/deleteNormalStore.action?store.id="+id;
}
//删除
function updateStore(id){
	window.location.href = "${dynamicURL}/basicdata/updateNormalStore.action?store.id="+id;
}


function createStore(){
	document.getElementById('searchForm').onsubmit=function(){ return false; };
	window.location.href = "${dynamicURL}/basicdata/addNormalStore.action";
}
