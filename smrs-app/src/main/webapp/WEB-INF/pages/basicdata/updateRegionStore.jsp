	...
	<div style="overflow: hidden; position: relative; width: 750px;">
		<div>
			<ul style="width: 5000px;">
				...
				<li class="last"><a href="#">更新<s:property value="titleName"/></a></li>
			</ul>
		</div>
	</div>
</div>
<div class="section">
	...
	<div class="box">
		<div class="title">
			更新<s:property value="titleName"/><span class="hide"></span>
		</div>
		<div class="content">
			<s:form action="updateNormalStore" namespace="/basicdata" method="post" id="storeForm">
				<s:hidden name="store.storeType" value="3"/>
				...
				<div class="row">
				 ...
				 -->	
				<div class="row">
				<input type="submit" value="更新" class="button orange" onclick="updateStore()" />&nbsp;&nbsp;
...
function searchStore(){
	document.getElementById('storeForm').onsubmit=function(){ return false; };
	window.location.href = "${dynamicURL}/basicdata/searchNormalStore.action";
}
</script>
</body>
</html>
