...
<div id="breadcrumbs">
	<div><div><ul>
		...
		<li><a href="#">渠道管理</a></li>
		<li class="last"><a href="#">渠道查询</a></li>
	</ul></div></div>
</div>
<div class="section">
	...
	<div class="box">
		...
		<div class="content">
			<s:form action="searchChannel" namespace="/basicdata" method="get" id="searchForm">
				<table>
					<tr>
						<th>渠道名：</th>
						<th><s:textfield name="channel.name" /></th>
						<th>
							<button type="submit" class="orange" onclick="submitForm('searchChannel');"><span>查询</span></button>
							<button type="submit" class="blue" onclick="creatChannel()"><span>新建</span></button>
							<!-- 
...
<div class="section">
	<div class="box">
		...
		<div class="content">
			...
			<tbody>
					<!-- 数据行 -->
					<s:iterator value="pager.records" var="channel" status="status">
						<tr>
							<td ><a
								href='${dynamicURL}/basicdata/updateChannel.action?channel.id=<s:property value="id"/>'><s:property value="name" /></a></td>
							...
							<td>
								<img title="删除" border="0" src="${staticURL}/images/trash.png" 	onclick="delChannel(<s:property value="id"/>)">								
							</td>
						</tr>
					</s:iterator>
				</tbody>
...
function delChannel(id){
	...
	window.location.href = "${dynamicURL}/basicdata/deleteChannel.action?channel.id="+id;
}
function creatChannel(){
	document.getElementById('searchForm').onsubmit=function(){ return false; };
	window.location.href = "${dynamicURL}/basicdata/addChannelInit.action";
}
