...
$(document).ready(function(){
    ...
    $("#searchBtn").click(function(){
		...
		var time = $("#time").val();
    	var url = "getAllAppCall.action?time=" + time;
    ...
    $("#piechart").bind('jqplotDataClick',
    		function(ev, seriesIndex, pointIndex, data){
    	    	...
    	    	var url = "getSingleAppCall.action?time=" + time + "&appId=" + appId;		
    	    	//alert(url);
    	    	var title;
    	    	if(time == 'week') {
...
<div class="message blue">
		<span><b>说明：</b>本页面查看全业务调用汇总情况。（点击饼图查看具体系统近三周/三月 的调用频次和平耗时，以及调用前10）</span>
	</div>
	<div class="box" >
		<div class="title">
			选择查询条件
...
<script type='text/javascript'>
	var grid = $("#list1");
	grid.jqGrid({
		colNames: ['应用ID','应用系统', '调用次数', '平均消耗时间（毫秒）'],
		colModel: [
