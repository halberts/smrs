	    ...
	    <div>
			<div class="dataTables_filter"></div>
				...
				<div style="width: 100%;font-size: 11px; " id="userListDiv">
					<table>
					 <tr>
                         <td width="45%" height="25" valign="middle" align="middle"><strong>未分配功能</strong></td>
				                         <td width="10%" valign="middle">&nbsp;</td>
                         <td width="45%" height="25" valign="middle" align="middle"><strong>已有功能</strong></td>
				     </tr> 
                     <tr>
				       	  <td >
	                    	  <select id="leftList" name="leftAllList" class="multiple" multiple="multiple" size="5">
						           <s:iterator value="allResourceList" var ='dep'>
                    	 ...
                    	 <td>
	                    	  <select id="rigthList" name="selectedResources" class="multiple" multiple="multiple" size="5">
		                    	  <s:iterator value="group.resources" var ='dep'>
		                    	  	<option value="<s:property value='#dep.id'/>"><s:property value='#dep.name'/></option>
		                    	  </s:iterator>
	                    	  </select>			                    	  	
                    	  </td>
